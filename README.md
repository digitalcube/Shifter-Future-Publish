...
- GitHub Actions CI ワークフローを追加（PR 作成時に PHPStan と PHPCS を自動実行）
- PHP 要件を 8.0 から 8.1 に更新（first-class callable 構文に必要）
- PHPStan 設定でプラグイン定数を適切に処理するよう修正
- PHPCS のメインプラグインファイル命名規則の例外を追加
